...
class AuthorForm(forms.ModelForm):
    class Meta:
        model = Author
        fields = ['first_name', 'last_name', 'country', 'city', 'workplace', 'email', 'phone',
                  'messenger_contact', 'academic_degree', 'academic_title', 'orcid']
        widgets = {
            ...
            'messenger_contact': forms.TextInput(attrs={'class': 'form-control'}),
